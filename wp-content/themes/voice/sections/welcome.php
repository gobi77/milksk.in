	...
	<div class="welcome-panel-content">
		...
		<div class="welcome-panel-column-container">
			...
			<div class="welcome-panel-column welcome-panel-last">
				...
				<a class="button button-primary button-hero" href="http://mekshq.com/documentation/voice" target="_blank">Learn more</a> <span class="vce-customize-welcome">or <a href="<?php echo esc_url(admin_url('admin.php?page=vce_options')); ?>">start customizing</a> now</span>.
			</div>
